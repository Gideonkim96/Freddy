...
@section('title', 'How to stay safe online - Kemnet Technologies Limited')
				...
				<ul class="mobile-bar-items nav flex-column mobile-bar-bottom">
					<li class="nav-item">
						<div class="nav-item-inner">
							...
							<form method="get" class="search-form" action="/how-to-stay-safe-online">
								...
								<div class="col-md-12">
									<div class="page-title-inner">
										<div class="pull-left">
											...
											<div id="breadcrumb" class="breadcrumb"><a href="/how-to-stay-safe-online">Home</a> <a
													href="/category/internet">Internet</a> <span
										...
										<nav class="navigation post-navigation">
											<div class="nav-links custom-post-nav">
												...
												<div class="prev-nav-link">
													...
													<a href="/how-to-optimize-your-wifi" class="prev">
												...
												<div class="next-nav-link">
													...
													<a href="/what-is-web-hosting" class="next">
												...
												<div id="respond" class="comment-respond">
													<h3 id="reply-title" class="comment-reply-title">Leave a Reply
														<small><a rel="nofollow" id="cancel-comment-reply-link"
																href="/how-to-stay-safe-online#respond" style="display:none;">Cancel
																Reply</a></small></h3>
							...
							<div class="col-lg-4">
								<aside class="widget-area right-widget-area">
									<section id="block-2" class="widget widget_block widget_search">
										<form role="search" method="get" action="/how-to-stay-safe-online"
											...
											<div
												...
												<ul class="wp-block-latest-posts__list wp-block-latest-posts">
													...
													<li><a class="wp-block-latest-posts__post-title"
															...
															hosting</a></li>
													<li><a class="wp-block-latest-posts__post-title"
															href="/how-to-stay-safe-online">How to stay safe online</a></li>
													<li><a class="wp-block-latest-posts__post-title"
										...
										<div class="widg-content">
											<ul class="side-newsfeed">
												...
												<li>
													<div class="side-item">
														<div class="side-image">
															<a href="/what-is-latency" rel="bookmark"><img
																	width="80" height="80"
														...
														<div class="side-item-text">
															<a class="themeh-color" href="/what-is-latency"
												...
												<li>
													<div class="side-item">
														<div class="side-image">
															<a href="/how-to-stay-safe-online" rel="bookmark"><img width="80"
																	height="80"
														...
														<div class="side-item-text">
															<a class="themeh-color" href="/how-to-stay-safe-online" rel="bookmark">How
									...
									<div class="nav-item-inner">
										<div class="copyright-text-wrap">Copyrights ©
											<script>document.write(new Date().getFullYear());</script> <a
												href="/how-to-stay-safe-online" class="theme-color" target="_blank">KEMNET
