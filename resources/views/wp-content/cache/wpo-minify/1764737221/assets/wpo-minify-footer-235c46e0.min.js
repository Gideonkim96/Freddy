...
var wpcf7_recaptcha = {
    "sitekey": "6Lfn4X0qAAAAAOvFqOP4V_3SLg_r9OKF6yhrRQnm",
    "actions": {
        "homepage": "homepage",
...
(function($){var WidgetAnimateTextHandler=function($scope,$){$scope.find('.typing-text').each(function(index){satenet_animated_text_settings(this,index)})};var WidgetIsotopeHandler=function($scope,$){$scope.find('.isotope').each(function(){satenet_isotope_layout(this)})};var WidgetOwlCarouselHandler=function($scope,$){$scope.find('.owl-carousel').each(function(){satenet_owl_settings(this)})};var WidgetCircleProgressHandler=function($scope,$){if($scope.find('.circle-progress-circle').length){var circle_ele=$scope.find('.circle-progress-circle');satenet_circle_progres_settings(circle_ele)}};var WidgetCounterUpHandler=function($scope,$){if($scope.find('.counter-up').length){var counter_ele=$scope.find('.counter-up');satenet_counter_up_settings(counter_ele)}};var WidgetDayCounterHandler=function($scope,$){$scope.find('.day-counter').each(function(){satenet_day_counter_settings(this)})};var WidgetChartHandler=function($scope,$){$scope.find('.pie-chart').each(function(){satenet_pie_chart_settings(this)});$scope.find('.line-chart').each(function(){satenet_line_chart_settings(this)})};var WidgetRoundTabHandler=function($scope,$){$scope.find('.round-tab-wrapper').each(function(){satenet_round_tab_settings(this)})};var WidgetModalPopupHandler=function($scope,$){if($scope.find('.modal-popup-wrapper.page-load-modal').length){var modal_id=$scope.find('.modal-popup-wrapper.page-load-modal .white-popup-block').attr("id");$.magnificPopup.open({items:{src:'#'+modal_id},type:'inline'})}};var WidgetAgonHandler=function($scope,$){if($scope.find(".canvas_agon").length){$scope.find('.canvas_agon').each(function(){satenet_agon(this)})}};var WidgetTimelineSliderHandler=function($scope,$){if($scope.find('.cd-horizontal-timeline').length){var line_dist=$scope.find('.cd-horizontal-timeline').data("distance")?$scope.find('.cd-horizontal-timeline').data("distance"):60;$scope.find('.cd-horizontal-timeline').zozotimeline({distance:line_dist})}};var WidgetRecentPopularToggleHandler=function($scope,$){if($scope.find(".satenet-toggle-post-trigger").length){$scope.find(".satenet-toggle-post-trigger .switch-checkbox").change(function(){satenet_switch_tab_toggle(this)})}};var SectionCustomOptionsHandler=function($scope,$){if($scope.is('section')){if($scope.is('section[data-satenet-float]')){satenet_section_float_parallax($scope)}
if($scope.is('section[data-satenet-raindrops]')){satenet_section_rain_drops($scope)}
if($scope.is('section[data-satenet-parallax-data]')){satenet_section_parallax($scope)}}};var ColumnCustomOptionsHandler=function($scope,$){if($scope.is('.elementor-element.elementor-column')){if($scope.is('.elementor-element.elementor-column[data-satenet-slide]')){satenet_content_slider($scope)}}};var WidgetZoomGalleryHandler=function($scope,$){if($scope.find(".popup-portfolio-gallery").length){$scope.find('.popup-portfolio-gallery').each(function(index){satenet_popup_gallery(this)})}};var WidgetToggleContentHandler=function($scope,$){if($scope.find(".toggle-content-wrapper").length){$scope.find('.toggle-content-wrapper').each(function(index){satenet_toggle_content(this)})}};$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/togglecontent.default',WidgetToggleContentHandler);elementorFrontend.hooks.addAction('frontend/element_ready/animtext.default',WidgetAnimateTextHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetcircleprogress.default',WidgetCircleProgressHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetcounter.default',WidgetCounterUpHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetdaycounter.default',WidgetDayCounterHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetimagegrid.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetmodalpopup.default',WidgetModalPopupHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenettimeline.default',WidgetAgonHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenettimelineslide.default',WidgetTimelineSliderHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetchart.default',WidgetChartHandler);elementorFrontend.hooks.addAction('frontend/element_ready/roundtab.default',WidgetRoundTabHandler);elementorFrontend.hooks.addAction('frontend/element_ready/section',SectionCustomOptionsHandler);elementorFrontend.hooks.addAction('frontend/element_ready/column',ColumnCustomOptionsHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetblog.default',WidgetIsotopeHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetblog.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetrecentpopular.default',WidgetRecentPopularToggleHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetteam.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetevent.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetservice.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenettestimonial.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetportfolio.default',WidgetIsotopeHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetportfolio.default',WidgetOwlCarouselHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetportfolio.default',WidgetZoomGalleryHandler);elementorFrontend.hooks.addAction('frontend/element_ready/satenetproducts.default',function($scope){console.log("satenet products ready");setTimeout(function(){var iframe=$("#elementor-preview-iframe");$(iframe).attr("src",$(iframe).attr("src"))},3000)})});$(window).on('load',function(){if($(".page-loader").length){$(".page-loader").fadeOut("slow")}else if($("body.opacity-zero").length){$("body").removeClass("opacity-zero");$("body").addClass("opacity-one")}});function satenet_scroll_animation(c_elem){setTimeout(function(){var anim_time=300;$(c_elem).find('.satenet-animate:not(.run-animate)').each(function(){var elem=$(this);var bottom_of_object=elem.offset().top;var bottom_of_window=$(window).scrollTop()+$(window).height();if(bottom_of_window>bottom_of_object){setTimeout(function(){elem.addClass("run-animate")},anim_time)}
anim_time+=300})},300)}
function satenetzozotimeline(cur_ele){var cur_ele=$(cur_ele);var line_dist=cur_ele.data("distance")?cur_ele.data("distance"):60;cur_ele.zozotimeline({distance:line_dist})}
function satenet_toggle_content(toggle_ele){var toggle_ele=$(toggle_ele).find(".toggle-content");var org_hgt=$(toggle_ele).height();var toggle_hgt=$(toggle_ele).data("height");$(toggle_ele).css('max-height',toggle_hgt);$(toggle_ele).addClass("toggle-content-shown");var btn_txt_wrap=$(toggle_ele).parents(".toggle-content-inner").find(".toggle-btn-txt");var btn_org_txt=$(btn_txt_wrap).text();var btn_atl_txt=$(toggle_ele).parents(".toggle-content-inner").find(".toggle-content-trigger").data("less");$(toggle_ele).parents(".toggle-content-inner").find(".toggle-content-trigger").on("click",function(e){event.preventDefault();$(toggle_ele).toggleClass("height-expandable");if($(toggle_ele).hasClass("height-expandable")){$(toggle_ele).css('max-height',org_hgt);$(btn_txt_wrap).text(btn_atl_txt)}else{$(toggle_ele).css('max-height',toggle_hgt);$(btn_txt_wrap).text(btn_org_txt)}})}
function satenet_popup_gallery(popup_ele){var popup_ele=$(popup_ele);popup_ele.magnificPopup({delegate:'a.popup-img',type:'image',mainClass:'mfp-img-mobile',gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',titleSrc:function(item){return item.el.attr('title')}}})}
function satenet_round_tab_settings(tab_ele){var tab_ele=$(tab_ele);tab_ele.find(".round-tab-head").on('click',function(){$(this).parents(".round-tab-wrapper").children(".round-tab-item").removeClass("active");$(this).parent(".round-tab-item").addClass("active")})}
function satenet_section_rain_drops(rd_ele){rd_ele.addClass("section-raindrops-actived");var rd_json=JSON.parse(decodeURIComponent(rd_ele.attr("data-satenet-raindrops")));rd_ele.append('<div class="satenet-raindrops-wrap"></div>');var rd_color=rd_json.rd_color;var rd_height=rd_json.rd_height;var rd_speed=rd_json.rd_speed;var rd_freq=rd_json.rd_freq;var rd_density=rd_json.rd_density;var rd_id=rd_json.id;var rd_pos=rd_json.rd_pos;if(rd_pos=="top"){rd_ele.find(".satenet-raindrops-wrap").css({"top":"-"+rd_height+"px"})}else{rd_ele.find(".satenet-raindrops-wrap").css({"bottom":"0"})}
rd_ele.find(".satenet-raindrops-wrap").css("height",rd_height+"px");var rain_ele=rd_ele.find(".satenet-raindrops-wrap").raindrops({color:rd_color,canvasHeight:rd_height,rippleSpeed:rd_speed,frequency:rd_freq,density:rd_density,positionBottom:'0'})}
function satenet_content_slider(slide_ele){var slide_ele=$(slide_ele);var slide_json=JSON.parse(decodeURIComponent(slide_ele.attr("data-satenet-slide")));console.log(slide_json);var children_ele=slide_ele.children(".elementor-widget-wrap");$(children_ele).addClass("owl-carousel");satenet_owl_json_settings(children_ele,slide_json)}
function satenet_section_parallax(pr_ele){var pr_ele=$(pr_ele);var pr_json=JSON.parse(decodeURIComponent(pr_ele.attr("data-satenet-parallax-data")));var parallax_ratio=pr_json.parallax_ratio;var parallax_img=pr_json.parallax_image;pr_ele.prepend('<div class="satenet-parallax" data-satenet-parallax data-speed="'+parallax_ratio+'" style="background-image:url('+parallax_img+')"></div>');var $fwindow=$(window);var scrollTop=window.pageYOffset||document.documentElement.scrollTop;$fwindow.on('scroll resize',function(){scrollTop=window.pageYOffset||document.documentElement.scrollTop});$(pr_ele).find('.satenet-parallax').each(function(){var $backgroundObj=$(this);var bgOffset=parseInt($backgroundObj.offset().top);var yPos;var coords;var speed=($backgroundObj.data('speed')||0);$fwindow.on('scroll resize',function(){yPos=-((scrollTop-bgOffset)/speed);coords='10% '+yPos+'px';$backgroundObj.css({backgroundPosition:coords})})});$fwindow.trigger('scroll')}
function satenet_section_float_parallax(pr_ele){var pr_ele=$(pr_ele);var pr_json=JSON.parse(decodeURIComponent(pr_ele.attr("data-satenet-float")));var fload_id=1;$.each(pr_json,function(idx,obj){var float_title=obj.float_title;var float_img=obj.float_img;var float_left=obj.float_left;var float_top=obj.float_top;var float_distance=obj.float_distance;var float_animation=obj.float_animation;var float_mouse=obj.float_mouse;var float_width=obj.float_width;var classname=float_animation!='0'?' floating-animate-model-'+float_animation:'';pr_ele.prepend('<div id="float-parallax-'+fload_id+'" class="float-parallax'+classname+'" data-mouse="'+float_mouse+'" data-left="'+float_left+'" data-top="'+float_top+'" data-distance="'+float_distance+'"><img alt="'+float_title+'" src="'+float_img+'" /></div>');$("#float-parallax-"+fload_id).satenetparallax({t_top:float_top,t_left:float_left,x_level:float_distance,mouse_animation:float_mouse,ele_width:float_width});fload_id++})}
function satenet_switch_tab_toggle(toggle_ele){if(toggle_ele.checked){var toggle_ele=$(toggle_ele);toggle_ele.parents(".satenet-toggle-post-wrap").addClass("satenet-active-post")}else{var toggle_ele=$(toggle_ele);toggle_ele.parents(".satenet-toggle-post-wrap").removeClass("satenet-active-post")}}
function satenet_agon(canvas_ele){var canvas_ele=$(canvas_ele);var canvas=canvas_ele[0];var cxt=canvas.getContext("2d");var agon_size=canvas_ele.attr("data-size");var agon_side=canvas_ele.attr("data-side");var agon_color=canvas_ele.attr("data-color");var div_val=1;switch(parseInt(agon_side)){case 3:div_val=6;break;case 4:div_val=4;break;case 5:div_val=3.3;break;case 6:div_val=3;break;case 7:div_val=2.8;break;case 8:div_val=2.7;break;case 9:div_val=2.6;break;case 10:div_val=2.5;break}
...
function satenet_counter_up_settings(counterup){counterup.appear(function(){var $this=$(this),countTo=$this.attr("data-count"),duration=$this.attr("data-duration");$({countNum:$this.text()}).animate({countNum:countTo},{duration:parseInt(duration),easing:'swing',step:function(){$this.text(Math.floor(this.countNum))},complete:function(){$this.text(this.countNum)}})})}
function satenet_day_counter_settings(day_counter){var day_counter=$(day_counter);var c_date=day_counter.attr('data-date');day_counter.countdown(c_date,function(event){if(day_counter.find('.counter-day').length){day_counter.find('.counter-day h3').text(event.strftime('%D'))}
