				...
				<ul class="mobile-bar-items nav flex-column mobile-bar-bottom">
					<li class="nav-item">
						<div class="nav-item-inner">
							...
							<form method="get" class="search-form" action="/kemnet-business-internet">
										...
										<li id="menu-item-14707"
											...
											<ul role="menu" class=" dropdown-menu">
												...
												<li id="menu-item-15874"
													...
													<a href="/kemnet-business-internet" class="nav-link">Business Internet</a></li>
									...
									<div class="menu-footer3-packages-container">
										<ul id="menu-footer3-packages" class="menu">
											...
											<li id="menu-item-15896"
												...
												<a href="/kemnet-business-internet" aria-current="page">Kemnet Business Internet</a>
											</li>
										</ul>
									</div>
								</section>
									...
									<div class="nav-item-inner">
										<div class="copyright-text-wrap">Copyrights ©
											<script>document.write(new Date().getFullYear());</script> <a
												href="/kemnet-business-internet" class="theme-color" target="_blank">KEMNET
